...
In the home page I added the logo, background image with company name ,slogan and call to action button which helps users to call and order.
 ...
 # About 
 In  the about us section i added all the information about the Pickle Brand

# Menu
In the menu section contains all varieties of Pickles and some images to look beautiful

# Products
In the top Product section I added image and product. These product are one of the top selling product as well as Appemidi and Birdeye chilly one of the top product that uses for making the traditional pickle

# Review
In this section I added customer review section in the website 
Contact: :  in this section i added location, any queries from the customer they can contact the brand also

# Blogs  
 I added blog section also
